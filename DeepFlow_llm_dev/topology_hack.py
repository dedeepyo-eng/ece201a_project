...
class Topology:
  def __init__(self, exp_config):
    ...
    #TODO: HACK, par2Dev need to be uncommented ASAP
    ...
    #TODO: HACK, sanitycheck need to be uncommented ASAP
    ...
    self.intra_par          = True
    self.inter_par          = False;
    self.intraNodeDegree    = 2
    self.interNodeDegree    = 2

    #NOTE: This is a hack
    #Adduming only one kind of parallelism exists at a time
    if self.dp_dim > self.num_nodes_per_wafer:
        self.data_intra = False
        self.intra_par  = False
        self.inter_par  = True
    if self.kp_dim > self.num_nodes_per_wafer:
        self.kernel_intra = False
        self.intra_par  = False
        self.inter_par  = True
    if self.lp_dim > self.num_nodes_per_wafer:
