...
idle_time = 0.0 # return for roofline only
...
# Mode parameter
    ...
    def roofline(self, flop, mem_access_, name="", info=False):
        ...
        global idle_time
        idle_time = float("inf") if (self.th == 0) else (flop / self.th)
        return max_time
    ...
    def getGEMMTime(self, dim1, dim2, dim3, name, original=False):
        ...
        # print(f"Gemm {name}, best time {best_time}, best comp time {best_comp}")

        return best_time, best_comp, best_tile_dims, mem_access
