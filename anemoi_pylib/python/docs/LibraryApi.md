...
with danka_thermal_api.ApiClient(configuration) as api_client:
    ...
    api_instance = danka_thermal_api.LibraryApi(api_client)
    data = danka_thermal_api.Library() # Library | 
...
with danka_thermal_api.ApiClient(configuration) as api_client:
    ...
    api_instance = danka_thermal_api.LibraryApi(api_client)
    libraryid = 56 # int | 
data = danka_thermal_api.Material() # Material | 
