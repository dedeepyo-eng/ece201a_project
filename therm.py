...
def therm(therm_conf, heatsink_conf, bonding_conf, heatsink, out_dir, project_name, simtype = "Anemoi", is_repeat = False, hbm_stack_height = 1, system_type = "2p5D", dummy_si = False, tim_cond_list = (5, 10, 50), infill_cond_list = (1.6, 19), underfill_cond_list = (1.6, 19)):
    ...
    kp1 = GPU_count_sqrt
    kp2 = GPU_count_sqrt
    run_file_path = "/app/nanocad/projects/deepflow_thermal/DeepFlow/local_DeepFlow/DeepFlow/scripts/run.sh"
    ...
    runtimes = []
    file_path = "/app/nanocad/projects/deepflow_thermal/DeepFlow/local_DeepFlow/DeepFlow/configs/new-configs/testing_thermal_A100.yaml"
    ...
    while(abs(old_HBM_peak_temperature - current_HBM_peak_temperature) > 1):
        ...
        os.chdir("/app/nanocad/projects/deepflow_thermal/DeepFlow/local_DeepFlow/DeepFlow/scripts")
